...
def get_estimator(scorer_type, save_folder=None):
    ...
    if scorer_type == 'voting_mlps_hard':
        ...
        mlp1 = MultiThreadingFeedForwardMLP(n_classes=3, batch_size=188, hm_epochs=100, keep_prob_const=1.0, optimizer='adam',
        ...
        # seed = np.random.randint(1, sys.maxsize)
        # mlp2 = MultiThreadingFeedForwardMLP(n_classes=4, batch_size=188, hm_epochs=10, keep_prob_const=1.0, optimizer='adam',
        #                                    learning_rate=0.01, step_decay_LR=True, weight_init='sqrt_n', bias_init=0.001,
        #                                    hidden_layers=(362, 942, 1071, 870, 318, 912, 247), activation_function='relu',
        #                                    save_folder=save_folder, seed=seed)
        # seed = np.random.randint(1, sys.maxsize)
        # mlp3 = MultiThreadingFeedForwardMLP(n_classes=4, batch_size=188, hm_epochs=10, keep_prob_const=1.0, optimizer='adam',
        #                                    learning_rate=0.01, step_decay_LR=True, weight_init='sqrt_n', bias_init=0.001,
        #                                    hidden_layers=(362, 942, 1071, 870, 318, 912, 247), activation_function='relu',
        #                                    save_folder=save_folder, seed=seed)
        # seed = np.random.randint(1, sys.maxsize)
        # mlp4 = MultiThreadingFeedForwardMLP(n_classes=4, batch_size=188, hm_epochs=10, keep_prob_const=1.0, optimizer='adam',
        #                                    learning_rate=0.01, step_decay_LR=True, weight_init='sqrt_n', bias_init=0.001,
        #                                    hidden_layers=(362, 942, 1071, 870, 318, 912, 247), activation_function='relu',
        #                                    save_folder=save_folder, seed=seed)
        # seed = np.random.randint(1, sys.maxsize)
        # mlp5 = MultiThreadingFeedForwardMLP(n_classes=4, batch_size=188, hm_epochs=10, keep_prob_const=1.0, optimizer='adam',
        #                                    learning_rate=0.01, step_decay_LR=True, weight_init='sqrt_n', bias_init=0.001,
        #                                    hidden_layers=(362, 942, 1071, 870, 318, 912, 247), activation_function='relu',
        #                                    save_folder=save_folder, seed=seed)
